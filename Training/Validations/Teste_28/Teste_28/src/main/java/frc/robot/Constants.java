...
public class Constants 
{
    ...
    {
        public static final double swerveDeadband = 0.15; // 0.04
        public static final int driveXAxis = 1;
        public static final int driveYAxis = 0;
        public static final int driveOmegaAxis = 4; // 2
        public static final int resetGyroButton = 4; //2
        public static final int driveModeButton = 5;  // 7
    }
    ...
    public static class Swerve 
    {
        ...
        public static final double angleConversionFactor = SwerveMath.calculateDegreesPerSteeringRotation(22.250, 1); // 22.250
    }
}
