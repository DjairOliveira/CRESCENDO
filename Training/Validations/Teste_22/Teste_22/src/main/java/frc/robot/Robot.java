...
private CANSparkMax TMSE;
  ...
  public static boolean Analog_Stimulated(int Axisx, int Axisy, double Range)
  {
    if (controller.getRawAxis(Axisx) <= -Range || controller.getRawAxis(Axisx) >= Range || controller.getRawAxis(Axisy) <= -Range || controller.getRawAxis(Axisy) >= Range) 
    {
      return true;
    }
    else
  ...
  public void teleopPeriodic() 
  {
    ...
    if(FLAG1_PID_P==false)
    {
      if (Analog_Stimulated(0, 1, 0.15)) 
      {
        ...
        if(controller.getRawAxis(4) >= 0.15 || controller.getRawAxis(4) <= -0.15 )
        {
          ...
          // AMSE.getPIDController().setReference(115 / 16.83816651075772, ControlType.kPosition);
          ////////
          // if(absoluteYaw>=45 && absoluteYaw<=224.999)
          // {
          //   AMID.getPIDController().setReference((absoluteYaw+JoyRight_degrees) / 16.83816651075772, ControlType.kPosition);
          //   AMIE.getPIDController().setReference((absoluteYaw+JoyRight_degrees) / 16.83816651075772, ControlType.kPosition);
          //   AMSE.getPIDController().setReference((absoluteYaw+JoyLeft_degrees) / 16.83816651075772, ControlType.kPosition);
          //   AMSD.getPIDController().setReference((absoluteYaw+JoyLeft_degrees) / 16.83816651075772, ControlType.kPosition);
            
          //   SmartDashboard.putNumber("TESTE", 4);
          // }

          // if((absoluteYaw>=315 && absoluteYaw<=359.999) || absoluteYaw<=134.999)
          // {
          //   AMSD.getPIDController().setReference((absoluteYaw+JoyRight_degrees) / 16.83816651075772, ControlType.kPosition);
          //   AMID.getPIDController().setReference((absoluteYaw+JoyRight_degrees) / 16.83816651075772, ControlType.kPosition);
          //   AMIE.getPIDController().setReference((absoluteYaw+JoyLeft_degrees) / 16.83816651075772, ControlType.kPosition);
          //   AMSE.getPIDController().setReference((absoluteYaw+JoyLeft_degrees) / 16.83816651075772, ControlType.kPosition);

          //   SmartDashboard.putNumber("TESTE", 1);
          // }
          // if((absoluteYaw>=225 && absoluteYaw<=359.999) || absoluteYaw<=44.999)//
          // {
          //   AMSD.getPIDController().setReference((absoluteYaw+JoyRight_degrees) / 16.83816651075772, ControlType.kPosition);
          //   AMSE.getPIDController().setReference((absoluteYaw+JoyRight_degrees) / 16.83816651075772, ControlType.kPosition);
          //   AMIE.getPIDController().setReference((absoluteYaw+JoyLeft_degrees) / 16.83816651075772, ControlType.kPosition);
          //   AMID.getPIDController().setReference((absoluteYaw+JoyLeft_degrees) / 16.83816651075772, ControlType.kPosition);

          //   SmartDashboard.putNumber("TESTE", 2);
          // }
          // if(absoluteYaw>=135 && absoluteYaw<=314.999)  //
          // {
          //   AMSE.getPIDController().setReference((absoluteYaw+JoyRight_degrees) / 16.83816651075772, ControlType.kPosition);
          //   AMIE.getPIDController().setReference((absoluteYaw+JoyRight_degrees) / 16.83816651075772, ControlType.kPosition);
          //   AMSD.getPIDController().setReference((absoluteYaw+JoyLeft_degrees) / 16.83816651075772, ControlType.kPosition);
          ...
          //   SmartDashboard.putNumber("TESTE", 3);
          // }

          if(absoluteYaw>=315 || absoluteYaw<=44.999)
          {
            // double result=0;
            // if(absoluteYaw>=315 && absoluteYaw<=359.999) result = MAP(absoluteYaw, 315, 359.999, 0.1, 0.4);
            // if(absoluteYaw>=0 && absoluteYaw<=44.999) result=MAP(absoluteYaw, 0, 44.999, 0.4, 0.1);

            // SmartDashboard.putNumber("MAP1", result);
            // M1=result*Velocit;
            // M2=(result/1.333333)*Velocit;
            // M3=(result/2)*Velocit;
            // M4=(result/4)*Velocit;
          ...
          {
            // double result=0;
            // if(absoluteYaw<=89.999) result = MAP(absoluteYaw, 45, 89.999, 0.1, 0.4);
            // else result = MAP(absoluteYaw, 89.999, 134.999, 0.4, 0.1);

            // SmartDashboard.putNumber("MAP2", result);
            // M1=(result/4)*Velocit;
            // M2=(result/2)*Velocit;
            // M3=(result/1.333333)*Velocit;
            // M4=result*Velocit;
            AMIE.getPIDController().setReference((absoluteYaw+JoyRight_degrees) / 16.83816651075772, ControlType.kPosition);
            AMSE.getPIDController().setReference((absoluteYaw+JoyRight_degrees) / 16.83816651075772, ControlType.kPosition);
            AMSD.getPIDController().setReference((absoluteYaw+JoyLeft_degrees) / 16.83816651075772, ControlType.kPosition);
          ...
          {
            // double result=0;
            // if(absoluteYaw<=179.999) result = MAP(absoluteYaw, 135, 179.999, 0.1, 0.4);
            // else result = MAP(absoluteYaw, 179.999, 224.999, 0.4, 0.1);
            
            // SmartDashboard.putNumber("MAP3", result);
            // M1=(result/2)*Velocit;
            // M2=(result/1.333333)*Velocit;
            // M3=result*Velocit;
            // M4=(result/4)*Velocit;
          ...
          {
            // double result=0;
            // if(absoluteYaw<=269.999) result = MAP(absoluteYaw, 135, 269.999, 0.1, 0.4);
            // else result = MAP(absoluteYaw, 269.999, 314.999, 0.4, 0.1);

            // SmartDashboard.putNumber("MAP4", result);
            // M1=(result/4)*Velocit;
            // M2=result*Velocit;
            // M3=(result/1.333333)*Velocit;
            // M4=(result/2)*Velocit;
    ...
    SmartDashboard.putNumber("POSI RODA ROTATION", (absoluteYaw+JoyLeft_degrees)+45);
