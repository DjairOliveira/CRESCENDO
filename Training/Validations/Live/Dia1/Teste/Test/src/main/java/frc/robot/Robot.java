...
public class Robot extends TimedRobot {
  ...
  {
    InD_Pin0 = new  DigitalInput(5);  // Define o Pino 0 como Entrada Digital
    OutD_Pin1 = new DigitalOutput(9); // Define o Pino 1 como saida Digital
    InA_Pin0 = new AnalogInput(3);    // Define o Pino 0 como Entrada Analógica
