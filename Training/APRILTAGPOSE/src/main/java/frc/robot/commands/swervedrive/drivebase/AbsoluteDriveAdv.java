...
public class AbsoluteDriveAdv extends Command
{
  ...
  private final BooleanSupplier lookAway, lookTowards, lookLeft, lookRight, lookAng1, lookAng2;
   ...
   * @param lookAng1       Face source
   * @param lookAng2       Face Source
   */
  public AbsoluteDriveAdv(SwerveSubsystem swerve, DoubleSupplier vX, DoubleSupplier vY, DoubleSupplier headingAdjust,
                          ...
                          BooleanSupplier lookRight, BooleanSupplier lookAng1, BooleanSupplier lookAng2)
  {
    this.swerve = swerve;
    this.vX = vX;
    this.vY = vY;
    ...
    this.lookAng1 = lookAng1;
    this.lookAng2 = lookAng2;
  ...
  public void execute()
  {
    ...
    if (lookAng1.getAsBoolean())
    {
      headingX = -0.75;
      headingY = -0.75;
    }

    if (lookAng2.getAsBoolean())
    {
      headingX = 0.75;
      headingY = -0.75;
    }
